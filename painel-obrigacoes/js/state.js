...
// A competência é o período de movimento/apuração, não o vencimento.
...
export function competenceForCompletion(completion, currentObligation = null) {
  ...
  return competenceForOccurrence(obligationForCompletion(completion, currentObligation), completion?.occurrence_date);
}
